package com.wipro.onetomany.config;
...
@ComponentScan("com.wipro.onetomany")
			...
			public DataSource DataSource()
			{
			  ...
			  @Bean
			    public LocalSessionFactoryBean sessionFactory() {
			        ...
			        sessionFactory.setAnnotatedClasses(Student.class, ReportCard.class,Courses.class);
